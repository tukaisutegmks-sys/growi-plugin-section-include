...
const enhanceOptions = (options: RendererOptions): RendererOptions => {
  ...
  if (Anchor != null && (Anchor as any).__sectionIncludeWrapped !== true) {
...
const activate = (): void => {
  ...
  if (optionsGenerators.generatePreviewOptions != null) {
    previousPreviewGenerator = optionsGenerators.customGeneratePreviewOptions;
...
const deactivate = (): void => {
  ...
  optionsGenerators.customGeneratePreviewOptions = previousPreviewGenerator;
};
